...
while ($arrayp=mysqli_fetch_array($exeSQL))
{
    ...
    echo "<p><b>&pound;".$arrayp['prodPrice']."</b>"; // Added missing semicolon after "&pound"
    echo "<p>".$arrayp['prodQuantity'];

    echo "</td>";
    echo "</tr>";
    echo "<p>Number to be purchased: ";

// Fetch the stock level for the product from the database
//$stockLevel = $arrayp['prodQuantity'];

// Create the drop-down list
echo "<form action='basket.php' method='post'>";
echo "<select name='p_quantity'>";

// Loop to generate options in the drop-down list
